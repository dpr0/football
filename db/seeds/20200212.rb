...
d28 = Day.create(date: '12.02.2020'.to_date)
d28t1p1 = d28.day_players.create(team_id: 1, player_id:  6) # тигран
...
d28t2p3 = d28.day_players.create(team_id: 2, player_id:  3) # ден
d28t2p4 = d28.day_players.create(team_id: 2, player_id: 12) # саня
d28t2p5 = d28.day_players.create(team_id: 2, player_id: 36) # акоп
d28t2p6 = d28.day_players.create(team_id: 2, player_id:  7) # сандро
d28t2p7 = d28.day_players.create(team_id: 2, player_id: 22) # илья

d28t3p1 = d28.day_players.create(team_id: 3, player_id: 21) # я
d28t3p2 = d28.day_players.create(team_id: 3, player_id: 32) # игорь
d28t3p3 = d28.day_players.create(team_id: 3, player_id: 42) # сергей
d28t3p4 = d28.day_players.create(team_id: 3, player_id: 44) # валера
d28t3p5 = d28.day_players.create(team_id: 3, player_id: 16) # вася
d28t3p6 = d28.day_players.create(team_id: 3, player_id:  9) # вова
