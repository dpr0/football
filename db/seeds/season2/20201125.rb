...
g1385.goals.create(season_id: 2, team_id: 13, player_id: 2, assist_player_id: nil)
g1386 = Game.create(day_id: s2d27.id, team_left_id: 1, goals_left: 2, goals_right: 0, team_right_id: 2)
g1386.goals.create(season_id: 2, team_id: 6, player_id: 1, assist_player_id: 38)
g1386.goals.create(season_id: 2, team_id: 38, player_id: 1, assist_player_id: nil)
g1387 = Game.create(day_id: s2d27.id, team_left_id: 1, goals_left: 2, goals_right: 1, team_right_id: 3)
g1387.goals.create(season_id: 2, team_id: 38, player_id: 1, assist_player_id: nil)
g1387.goals.create(season_id: 2, team_id: 52, player_id: 1, assist_player_id: nil)
g1387.goals.create(season_id: 2, team_id: 21, player_id: 3, assist_player_id: nil)
g1388 = Game.create(day_id: s2d27.id, team_left_id: 1, goals_left: 2, goals_right: 1, team_right_id: 2)
g1388.goals.create(season_id: 2, team_id: 38, player_id: 1, assist_player_id: nil)
g1388.goals.create(season_id: 2, team_id: 6, player_id: 1, assist_player_id: nil)
g1388.goals.create(season_id: 2, team_id: 4, player_id: 2, assist_player_id: nil)
g1389 = Game.create(day_id: s2d27.id, team_left_id: 1, goals_left: 2, goals_right: 0, team_right_id: 3)
g1389.goals.create(season_id: 2, team_id: 52, player_id: 1, assist_player_id: nil)
g1389.goals.create(season_id: 2, team_id: 52, player_id: 1, assist_player_id: nil)
g1390 = Game.create(day_id: s2d27.id, team_left_id: 1, goals_left: 1, goals_right: 1, team_right_id: 2)
g1390.goals.create(season_id: 2, team_id: 29, player_id: 1, assist_player_id: nil)
g1390.goals.create(season_id: 2, team_id: 12, player_id: 2, assist_player_id: nil)
...
g1392.goals.create(season_id: 2, team_id: 6, player_id: 1, assist_player_id: nil)
g1392.goals.create(season_id: 2, team_id: 10, player_id: 2, assist_player_id: nil)
g1392.goals.create(season_id: 2, team_id: 10, player_id: 2, assist_player_id: nil)

g1393 = Game.create(day_id: s2d27.id, team_left_id: 4, goals_left: 1, goals_right: 0, team_right_id: 2)
g1393.goals.create(season_id: 2, team_id: 32, player_id: 4, assist_player_id: nil)
g1394 = Game.create(day_id: s2d27.id, team_left_id: 4, goals_left: 1, goals_right: 1, team_right_id: 3)
g1394.goals.create(season_id: 2, team_id: nil, player_id: 4, assist_player_id: nil)
g1394.goals.create(season_id: 2, team_id: 44, player_id: 3, assist_player_id: nil)
g1395 = Game.create(day_id: s2d27.id, team_left_id: 1, goals_left: 1, goals_right: 0, team_right_id: 2)
g1395.goals.create(season_id: 2, team_id: 29, player_id: 1, assist_player_id: nil)
...
g1397.goals.create(season_id: 2, team_id: 4, player_id: 2, assist_player_id: nil) # 4 ?????
...
g1399.goals.create(season_id: 2, team_id: 38, player_id: 1, assist_player_id: nil)
g1399.goals.create(season_id: 2, team_id: 38, player_id: 1, assist_player_id: nil)
g1399.goals.create(season_id: 2, team_id: 32, player_id: 4, assist_player_id: nil)
g1400 = Game.create(day_id: s2d27.id, team_left_id: 1, goals_left: 1, goals_right: 1, team_right_id: 3)
g1400.goals.create(season_id: 2, team_id: 38, player_id: 1, assist_player_id: nil)
g1400.goals.create(season_id: 2, team_id: 42, player_id: 3, assist_player_id: nil)
g1401 = Game.create(day_id: s2d27.id, team_left_id: 2, goals_left: 1, goals_right: 0, team_right_id: 4)
g1401.goals.create(season_id: 2, team_id: nil, player_id: 2, assist_player_id: nil)
g1402 = Game.create(day_id: s2d27.id, team_left_id: 2, goals_left: 1, goals_right: 0, team_right_id: 1)
g1402.goals.create(season_id: 2, team_id: 11, player_id: 2, assist_player_id: nil)
...
g1404.goals.create(season_id: 2, team_id: 38, player_id: 1, assist_player_id: nil)
g1404.goals.create(season_id: 2, team_id: 32, player_id: 4, assist_player_id: nil)
