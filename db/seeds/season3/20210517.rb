...
g2361.goals.create(season_id: 3, team_id: 3, player_id: 21, assist_player_id: 17)
...
g2364 = Game.create(day_id: s3d33.id, team_left_id: 4, goals_left: 1, goals_right: 0, team_right_id: 3)
g2364.goals.create(season_id: 3, team_id: 4, player_id: 53, assist_player_id: nil)
