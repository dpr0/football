...
g1901.goals.create(season_id: 3, team_id: 3, player_id: 22, assist_player_id: nil)
...
g1903 = Game.create(day_id: s3d14.id, team_left_id: 1, goals_left: 0, goals_right: 0, team_right_id: 3) # ???

g1904 = Game.create(day_id: s3d14.id, team_left_id: 1, goals_left: 2, goals_right: 0, team_right_id: 2)
g1904.goals.create(season_id: 3, team_id: 1, player_id: 18, assist_player_id: nil)
g1904.goals.create(season_id: 3, team_id: 1, player_id: 38, assist_player_id: nil)
g1905 = Game.create(day_id: s3d14.id, team_left_id: 1, goals_left: 1, goals_right: 1, team_right_id: 3)
g1905.goals.create(season_id: 3, team_id: 1, player_id: 6, assist_player_id: nil)
...
g1906.goals.create(season_id: 3, team_id: 3, player_id: 42, assist_player_id: nil)
...
g1908.goals.create(season_id: 3, team_id: 2, player_id: 53, assist_player_id: nil)
g1909 = Game.create(day_id: s3d14.id, team_left_id: 3, goals_left: 2, goals_right: 0, team_right_id: 2)
g1909.goals.create(season_id: 3, team_id: 3, player_id: 3, assist_player_id: nil)
g1909.goals.create(season_id: 3, team_id: 3, player_id: 3, assist_player_id: nil)
...
g1910.goals.create(season_id: 3, team_id: 1, player_id: 38, assist_player_id: nil)
...
g1912.goals.create(season_id: 3, team_id: 2, player_id: 1, assist_player_id: nil)
g1912.goals.create(season_id: 3, team_id: 2, player_id: 54, assist_player_id: 13)
...
g1917 = Game.create(day_id: s3d14.id, team_left_id: 3, goals_left: 1, goals_right: 1, team_right_id: 1)
g1917.goals.create(season_id: 3, team_id: 3, player_id: 50, assist_player_id: nil)
g1917.goals.create(season_id: 3, team_id: 1, player_id: 23, assist_player_id: nil)
g1918 = Game.create(day_id: s3d14.id, team_left_id: 2, goals_left: 1, goals_right: 2, team_right_id: 1)
g1918.goals.create(season_id: 3, team_id: 2, player_id: 1, assist_player_id: 4)
g1918.goals.create(season_id: 3, team_id: 1, player_id: 18, assist_player_id: 6)
g1918.goals.create(season_id: 3, team_id: 1, player_id: 10, assist_player_id: 18)
g1919 = Game.create(day_id: s3d14.id, team_left_id: 3, goals_left: 2, goals_right: 0, team_right_id: 1)
g1919.goals.create(season_id: 3, team_id: 3, player_id: 21, assist_player_id: 3)
g1919.goals.create(season_id: 3, team_id: 3, player_id: 44, assist_player_id: 50)
