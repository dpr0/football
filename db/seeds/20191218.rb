...
d15t1p1 = d15.day_players.create(team_id: 1, player_id: 19) # Ваня
d15t1p2 = d15.day_players.create(team_id: 1, player_id:  6) # Тигран
d15t1p3 = d15.day_players.create(team_id: 1, player_id:  9) # Вова
d15t1p4 = d15.day_players.create(team_id: 1, player_id: 25) # Серега С
d15t1p5 = d15.day_players.create(team_id: 1, player_id: 33) # Макс А
