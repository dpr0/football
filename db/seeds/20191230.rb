...
d17  = Day.create(date: '30.12.2019'.to_date)
d17t1p1 = d17.day_players.create(team_id: 1, player_id: 33) # Макс
d17t1p2 = d17.day_players.create(team_id: 1, player_id:  5) # Алихан
d17t1p3 = d17.day_players.create(team_id: 1, player_id: 23) # Врач
d17t1p4 = d17.day_players.create(team_id: 1, player_id: 25) # Серега
d17t1p5 = d17.day_players.create(team_id: 1, player_id:  1) # Гарик
d17t1p6 = d17.day_players.create(team_id: 1, player_id: 16) # Вася

d17t2p1 = d17.day_players.create(team_id: 2, player_id:  4) # Шах
d17t2p2 = d17.day_players.create(team_id: 2, player_id: 13) # Араз
d17t2p3 = d17.day_players.create(team_id: 2, player_id: 12) # Саша
d17t2p4 = d17.day_players.create(team_id: 2, player_id:  7) # Сандро

d17t3p1 = d17.day_players.create(team_id: 3, player_id: 21) # Я
d17t3p2 = d17.day_players.create(team_id: 3, player_id:  3) # Ден
d17t3p3 = d17.day_players.create(team_id: 3, player_id: 14) # Саша
d17t3p4 = d17.day_players.create(team_id: 3, player_id:  9) # Вова
