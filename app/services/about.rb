class About
      ...
      <div class='container demo'>
        <div class='content'>
          <div id='large-header' class='large-header' style='height: 373px;'>
            ...
            <h1 class='main-title'><span class='thin'><a href='https://t.me/dvitvitskiy'>@dvitvitskiy</a></span> home page</h1>
            <div class='krsz_items'>#{links}</div>
          </div>
        </div>
      </div>
  ...
  def links
    Common.sites.map { |name, str| "<div><a href='https://#{name}'><i class='#{str}'></i>&nbsp#{name}</a></div>" }.join("\n")
  end

  def style
    "
    body {background-color: #{['black', 'white'].sample}; }
    ...
    "(function() {
        ...
        function drawLines(p) {
            ...
            for(var i in p.closest) {
                ...
                ctx.strokeStyle = 'rgba(3,123,249,'+ p.active+')';
                ctx.stroke();
            }
        }
        ...
        function Circle(pos,rad,color) {
            ...
            this.draw = function() {
                ...
                ctx.fillStyle = 'rgba(3,129,249,'+ _this.active+')';
                ctx.fill();
            };
        }
